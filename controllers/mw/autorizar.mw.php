...
function generarMenu($usercod)
{
    ...
    // WW de Modas
    if (isAuthorized('transacciones',$usercod)) $menu[] = array("mdlprg"=>"transacciones","mdldsc"=>"Donaciones recibidas");

    if (isAuthorized('mantenimiento',$usercod)) $menu[] = array("mdlprg"=>"mantenimiento_donaciones","mdldsc"=>"Donaciones");
